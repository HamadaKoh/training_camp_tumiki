...
class MockRTCPeerConnection {
  ...
  constructor() {
    // Reset mock implementations for each instance
...
const mockRTCPeerConnection = MockRTCPeerConnection;
...
describe('useWebRTC', () => {
  ...
  describe('WebRTC Operations', () => {
    it('should create offer', async () => {
      ...
      // Wait for socket and PeerConnectionManager initialization
      await act(async () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle operations on non-existent peers', async () => {
      ...
      await act(async () => {
        ...
        await expect(
          result.current.handleOffer(nonExistentUserId, {} as RTCSessionDescriptionInit)
        ).rejects.toThrow();
        await expect(
          result.current.handleAnswer(nonExistentUserId, {} as RTCSessionDescriptionInit)
        ).rejects.toThrow();
        await expect(
          result.current.addIceCandidate(nonExistentUserId, {} as RTCIceCandidate)
        ).rejects.toThrow();
      });
    });
  });
